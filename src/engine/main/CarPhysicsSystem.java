...
//        float frontWeightRatio = engine.main.Physics.computeFrontWeightRatio(wheelBase, cd.cgToFrontAxle);
//        float rearWeightRatio = engine.main.Physics.computeRearWeightRatio(wheelBase, cd.cgToRearAxle);

//        float weightFront = engine.main.Physics.computeWeightFront(wheelBase, frontWeightRatio, cd.cgHeight, cd.mass, linearAcceleration);
//        float weightRear = engine.main.Physics.computeWeightRear(wheelBase, rearWeightRatio, cd.cgHeight, cd.mass, linearAcceleration);
...
//        Vector3 fLongitudinal = engine.main.Physics.computeLongitudinal(
//                engine.main.Physics.computeTraction(direction, cd.engineForce * cd.throttle),
//                engine.main.Physics.computeDrag(0.42f, velocity),
//                engine.main.Physics.computeRR(12, velocity)
//        );
